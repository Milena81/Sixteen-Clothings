...
<!-- <li><a href="/clothing_products/index/" title="view latest products" class="btn" class="page-heading products-heading header-text">Latest products <i class="fa fa-angle-right"></i></a></li> -->
<!-- <li><a href="/clothing_products/create/" title="insert new information" class="btn">Create new products <i class="fa fa-angle-right"></i></a></li> -->
<!--  <li><a href="/about_us_clothing/index/" title="more information about us" class="btn">About Us <i class="fa fa-angle-right"></i></a></li> -->
<!--  <li><a href="/contact_us_clothing/index/" title="our location..." class="btn">Contact Us <i class="fa fa-angle-right"></i></a></li> -->
<!-- </ul> -->
<!-- </div> -->
<!-- Page Content -->
      ...
      <div class="col-md-12">
        <div class="filters">
            ...
            <ul>
                ...
                style="color:red;"><h4><b>Flash Deals</b></h4></a></li>
